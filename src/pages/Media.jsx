    ...
    return (
        <>
            ...
            <div className="h-screen py-8 px-32 bg-red-100">
                <h2 className="text-3xl font-bold mb-6">Our Media</h2>
                <p>
                    Here you can describe additional details about your media, including specific entertainment options, pricing, or how to book your services.
                </p>
            </div>
            <Footer />
        </>
